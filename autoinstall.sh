...
echo -e "\e[43;1;30m                                                                         \033[0m"
echo -e "\e[43;1;30m   TOTUM AUTOINSTALL SCRIPT                                              \033[0m"
echo -e "\e[43;1;30m                                                                         \033[0m"
...
sudo curl -O https://raw.githubusercontent.com/totumonline/totum-mit/master/exim4.conf.template
sudo chown root:root ./exim4.conf.template
sudo mv ./exim4.conf.template /etc/exim4/exim4.conf.template

sudo curl -O https://raw.githubusercontent.com/totumonline/totum-mit/master/update-exim4.conf.conf
